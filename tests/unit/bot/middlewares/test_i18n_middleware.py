...
@pytest.mark.asyncio
async def test_get_locale_no_user(telegram_chat, telegram_message, mock_i18n):
    chat = telegram_chat
...
@pytest.mark.asyncio
async def test_get_locale_no_services(telegram_chat, telegram_user, telegram_message, mock_i18n):
    message = telegram_message(chat=telegram_chat, user=telegram_user(123))
